...
env_overridables = [
    ...
    'LRS_SIS_COURSE_ID_URI_TEMPLATE', 'LRS_SIS_SECTION_ID_URI_TEMPLATE',
    ...
    'GA_TRACKING_ID', 'COMPAIR_APP_URL_BASE'
]
...
env_bool_overridables = [
    ...
    'ENFORCE_SSL', 'IMPERSONATION_ENABLED', 'NOTIFICATION_ASSIGNMENT_ENDING_ENABLED'
]
